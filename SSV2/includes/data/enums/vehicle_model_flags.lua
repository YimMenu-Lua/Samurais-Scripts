...
local eVehicleModelFlags <const> = {
	...
	NO_FIRST_PERSON_LOOK_BEHIND = 14, -- Does not allow the player to use the "look behind" button while in first person view - it will instead enter third person mode and then look behind.
