...
return {
	...
	-- index + 148
	AutoShops         = {
		{ gxt = "AUT_SHP_GAR", coords = vec3:new(766.5528, -677.0346, 27.7239) }, -- am_mp_autoshop func_4309 // switch\s+\(\w+\)[\r\n]?.*?\{[\r\n]?.*?case\s+149:[\r\n]?.*?switch\s+\(\w+\)[\r\n]?\s+\{[\r\n]?\s+case\s+0:[\r\n]?\s+\*\w+\s+=
		{ gxt = "AUT_SHP_GAR", coords = vec3:new(-145.7606, -1346.8221, 28.7008) },
		{ gxt = "AUT_SHP_GAR", coords = vec3:new(-163.4841, -30.7421, 51.7085) },
		{ gxt = "AUT_SHP_GAR", coords = vec3:new(238.091, -1878.5231, 25.2772) },
		{ gxt = "AUT_SHP_GAR", coords = vec3:new(496.2674, -895.2114, 24.5897) },
	},
	-- index + 154
	Agencies          = {
	...
	Casino            = {
		{ gxt = "CASINO_ENT_T", coords = vec3:new(924.6380, 46.6918, 81.1063) }
	}
}
