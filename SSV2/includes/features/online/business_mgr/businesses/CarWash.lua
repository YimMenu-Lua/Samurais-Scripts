...
---@param key string
---@param yrv3_ref BusinessMgr
local function toggle_cd(key, yrv3_ref)
...
---@param yrv3_ref BusinessMgr
function CarWashSubBusiness:ToggleLegalWorkCooldown(yrv3_ref)
	toggle_cd(self.m_legal_work_cooldown_gvar_key, yrv3_ref)
end

---@param yrv3_ref BusinessMgr
function CarWashSubBusiness:ToggleIllegalWorkCooldown(yrv3_ref)
	toggle_cd(self.m_illegal_work_cooldown_gvar_key, yrv3_ref)
end
...
---@param yrv3_ref BusinessMgr
function CarWash:ToggleLegalWorkCooldown(yrv3_ref)
	toggle_cd("cwash_legal_work_cd", yrv3_ref)
end

---@param yrv3_ref BusinessMgr
function CarWash:ToggleIllegalWorkCooldown(yrv3_ref)
	toggle_cd("cwash_illegal_work_cd", yrv3_ref)
end
