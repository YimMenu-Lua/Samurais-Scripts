...
return function(business, isParent, kvSpacing, clearHeatLabel)
	...
	GUI:CustomToggle(_T("YRV3_CWASH_LEGAL_WORK_CD"),
		...
		{ onClick = function() business:ToggleLegalWorkCooldown(BusinessMgr) end } -- should use IManagedValue here instead of relying on YRV3
	)

	GUI:CustomToggle(_T("YRV3_CWASH_ILLEGAL_WORK_CD"),
		business:GetIllegalWorkCooldownState(),
		{ onClick = function() business:ToggleIllegalWorkCooldown(BusinessMgr) end }
	)
