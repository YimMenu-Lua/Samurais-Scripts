...
local drawVehicleWarehouse    = require("includes.frontend.business_mgr.vehicle_warehouse_ui")
...
local function drawSpecialCargo(warehouses)
	...
	if (GUI:Button(_T("YRV3_FINISH_SOURCE_MISSION"))) then
		BusinessMgr:FinishCEOCargoSourceMission()
	end
	ImGui.EndDisabled()
