return {
	...
	["CP_HEIST_MAX_PLAYER_CUTS"] = "Max Alle",
	...
	["YRV3_HANGAR_LAND_ERR"] = "Der Verkauf von Hangargrundstücken wird derzeit nicht unterstützt.",
	...
	["YRV3_INCOME_APPROX_ALL"] = "Prognostiziertes Einkommen",
	...
	["VEH_NO_ENGINE_BRAKE"] = "Keine Motorbremse",
	...
	["VEH_JUMP_TT"] = "Rüstet Ihr Fahrzeug mit einer Sprungfähigkeit aus, ähnlich dem „Ruiner 2000“. Drücken Sie während der Fahrt [E], um in die Luft zu springen, und drücken Sie dann die Leertaste, um einen Fallschirm auszufahren.",
	...
	["SELF_MC_BIKE_ANIMS_TT"] = "Ermöglicht alternative Fahrradfahranimationen.",
	...
	["GENERIC_LIST_SORT"] = "Sortieren",
	["GENERIC_LIST_FILTER"] = "Filter",
	["YAV3_ANIM_FLAGS"] = "Verhaltensflags",
	["YRV3_TRIGGER_PROD"] = "[ ! ] Produktion auslösen",
	["YRV3_TRIGGER_PROD_TT"] = "Löst die Produktion sofort einmal aus, solange Vorräte vorhanden sind. Sie können die Taste gedrückt halten, um es weiterhin auszulösen, oder „Produktionsschleife“ aktivieren, um den Prozess vollständig zu automatisieren.\n\n„Unsichere Funktionen“ müssen aktiviert sein.",
	["YRV3_AUTO_PROD"] = "[ ! ] Produktionsschleife",
	...
	["YRV3_TRIGGER_PROD_HUB_TT"] = "Löst im Laufe der Zeit immer wieder Produktion aus. Sie müssen sicherstellen, dass das verbundene Unternehmen eingerichtet ist und läuft und dass diesem Hub ein Techniker zugewiesen ist.\n\n„Unsichere Funktionen“ müssen aktiviert sein.",
	...
	["SETTINGS_NEW_THEME_NAME_EMPTY"] = "Bitte geben Sie einen gültigen Namen ein!",
	...
	["YRV3_UNSAFE_FEATS_PROMPT"] = "Diese Funktionen sind unsicher und können bei Missbrauch zur Kontosperrung führen.\n\nKlicken Sie auf „Bestätigen“, um diese Warnung zu bestätigen und das Risiko zu akzeptieren, oder auf „Abbrechen“, um zurückzukehren. Sie können diese Bestätigung jederzeit später widerrufen, indem Sie dieses Kontrollkästchen deaktivieren.",
	...
	["GENERIC_NAME"] = "Name",
	["GENERIC_NEXT"] = "Nächste",
	["GENERIC_PREFERENCES_LABEL"] = "Präferenzen",
	["GENERIC_REPAIR"] = "Reparieren",
	["GENERIC_EMERGENCY_STOP"] = "Not-Aus",
	["GENERIC_PREVIOUS"] = "Vorherige",
	["GENERIC_RESPAWN"] = "Respawn",
	["GENERIC_BRING"] = "Bringen",
	["GENERIC_DISMISS_ALL"] = "Alle verwerfen",
	["GENERIC_KILL"] = "Töten",
	["GENERIC_GOTO"] = "Gehe zu",
	["GENERIC_WANDER"] = "Wandern",
	["GENERIC_INVINCIBLE"] = "Unbesiegbar",
	["GENERIC_GENDER"] = "Geschlecht",
	["GENERIC_DRIVING_STYLE"] = "Fahrstil",
	["GENERIC_TYPE"] = "Typ",
	["GENERIC_MALE"] = "Männlich",
	["GENERIC_DRIVING_STYLE_NORMAL"] = "Normal",
	["GENERIC_FEMALE"] = "Weiblich",
	["GENERIC_PREVIEW"] = "Vorschau",
	["GENERIC_COMMANDS"] = "Befehle",
	["GENERIC_RIGHT_CLICK_TT"] = "Klicken Sie mit der rechten Maustaste, um weitere Optionen anzuzeigen.",
	["GENERIC_NORAGDOLL"] = "Stabil",
	["GENERIC_WARP_INTO_VEH"] = "Warp in das Fahrzeug",
	["GENERIC_TURN_ON"] = "Einschalten",
	["BSV2_ESCORTS_LABEL"] = "Begleitpersonen",
	["GENERIC_TURN_OFF"] = "Ausschalten",
	["BSV2_BODYGUARDS_LABEL"] = "Leibwächter",
	["GENERIC_DRIVING_STYLE_AGGRO"] = "Aggressiv",
	["BSV2_LIMO_LABEL"] = "Limousine",
	["BSV2_WEAPONS_LABEL"] = "Waffen",
	["BSV2_HELI_LABEL"] = "Hubschrauber",
	["BSV2_JET_LABEL"] = "Jet",
	["BSV2_GIVE_ALL_WEAPONS"] = "Gib alle Waffen",
	["BSV2_BG_SPAWNED_TAB"] = "Aktive Leibwächter",
	["BSV2_ES_SPAWNED_TAB"] = "Aktive Gruppen",
	["BSV2_DISPATCH"] = "Versenden",
	["BSV2_CALL"] = "Anruf",
	["BSV2_ES_DRIVING_OPTIONS"] = "Fahroptionen",
	["BSV2_ES_BRING_INTERIOR_ERR"] = "Es ist nicht möglich, Begleitgruppen in Innenräume mitzunehmen.",
	["BSV2_ES_DRIVE_WP"] = "Zum Wegpunkt fahren",
	["BSV2_ES_SPAWNED_NONE"] = "Sie haben keine Begleitgruppen entsandt.",
	["BSV2_BG_SPAWNED_NONE"] = "Sie haben keine Leibwächter entsandt.",
	["BSV2_ES_DRIVE_OBJ"] = "Fahren Sie zum Ziel",
	["BSV2_ES_NEW_GROUP_NAME_ERR"] = "Eine Gruppe mit diesem Namen existiert bereits. Bitte wählen Sie eine andere aus.",
	["BSV2_ES_TP_ERR"] = "Sie müssen draußen sein und zu Fuß stehen, um sich zu Ihrer Begleitgruppe zu teleportieren.",
	["BSV2_ES_GENERIC_CAR_ERR"] = "Aktion kann nicht ausgeführt werden! Ein oder mehrere Mitglieder der Begleitgruppe konnten nicht in das Fahrzeug einsteigen.",
	["BSV2_ES_VEH_INVALID_ERR"] = "Das Begleitfahrzeug scheint nicht mehr zu existieren.",
	["BSV2_ES_NEW_GROUP_PROMPT"] = "Sind Sie sicher, dass Sie die Gruppe %s erstellen möchten?",
	["BSV2_ES_NEW_GROUP_NAME"] = "Wählen Sie einen Namen für Ihre Gruppe",
	["BSV2_ES_NEW_GROUP_VEH"] = "Wählen Sie ein passendes Fahrzeug für Ihre Gruppe",
	["BSV2_ES_NEW_GROUP_STEP_LABEL"] = "Schritt %d / 3",
	["BSV2_ES_NEW_GROUP_MEMBERS"] = "Fügen Sie Ihrer Gruppe neue Mitglieder hinzu (nicht mehr als 3).",
	["BSV2_ES_NEW_GROUP_MEMBERS_COUNT"] = "Mitglieder: %d / 3",
	["BSV2_ES_NEW_GROUP_PED_NAME"] = "Mitgliedsname",
	["BSV2_LIMO_TAKE_CTRL"] = "Übernehmen Sie die Kontrolle",
	["BSV2_LIMO_MORE_OPTS_TT"] = "Steigen Sie in die Limousine, um weitere Optionen zu sehen.",
	["BSV2_ES_NEW_GROUP_PED_WEAPON"] = "Mitgliedswaffe",
	["BSV2_ES_NEW_GROUP_PED_MODEL"] = "Mitgliedsmodell",
	["BSV2_LIMO_TAKE_CTRL_TT"] = "Ermöglicht die Fernsteuerung der Limousine bequem vom Rücksitz aus.",
	["BSV2_RADIO_CTRL"] = "Funksteuerungen",
	["BSV2_LIMO_MODELS_AVAIL"] = "Verfügbare Limousinen",
	["BSV2_LIMO_GIVE_CTRL"] = "Geben Sie die Kontrolle zurück",
	["BSV2_SEAT_CTRL_NEXT"] = "Nächster Platz",
	["BSV2_SEAT_CTRL_PREV"] = "Vorheriger Sitzplatz",
	["BSV2_LIMO_GIVE_CTRL_TT"] = "Geben Sie dem Chauffeur die Kontrolle über die Limousine zurück.",
	["BSV2_HELI_MORE_OPTS_TT"] = "Steigen Sie in den Helikopter, um weitere Optionen zu sehen.",
	["BSV2_HELI_LAND_HERE"] = "Lande hier",
	["BSV2_HELI_MODELS_AVAIL"] = "Verfügbare Hubschrauber",
	["BSV2_SEAT_CTRL"] = "Sitzsteuerung",
	["BSV2_HELI_RAPPELL_SEAT_ERR"] = "Von diesem Sitz aus kann man sich nicht abseilen. Bitte wechseln Sie auf einen der Rücksitze!",
	["BSV2_AIRPORTS"] = "Flughäfen",
	["BSV2_HELI_PRESETS"] = "Voreingestellte Ziele",
	["BSV2_FLY_WP"] = "Zum Wegpunkt fliegen",
	["BSV2_HELI_RAPPELL"] = "Abseilen",
	["BSV2_FLY_SKIP"] = "Reise überspringen",
	["BSV2_HELI_HOVER_HERE"] = "Bewegen Sie den Mauszeiger hierher",
	["BSV2_FLY_OBJ"] = "Fliegen Sie zum Ziel",
	["BSV2_JET_MORE_OPTS_TT"] = "Steigen Sie in den Jet, um weitere Optionen zu sehen.",
	["BSV2_JET_LANDING_DEST"] = "Landeziele",
	["BSV2_JET_LANDING_SAME_AP_ERR"] = "Sie sind bereits bei %s.",
	["BSV2_JET_MODELS_AVAIL"] = "Verfügbare Jets",
	["BSV2_JET_SKIP_LANDING"] = "Landung überspringen",
	["BSV2_JET_TOO_FAR_WARN"] = "[HINWEIS]: Wenn Sie den Jet rufen, während er zu weit vom Flughafen entfernt ist, kann es dazu führen, dass er unsichtbar wird. Verwenden Sie entweder die Schaltfläche in dieser Benutzeroberfläche, um sich direkt in den Jet zu warpen (wodurch dieser sichtbar wird), oder rufen Sie einfach Ihren Jet an, wenn Sie sich in der Nähe des Flughafens befinden.",
	["ASSET_BROWSER_TRUNC_TT"] = "Die Liste wird gekürzt, um nur %d Einträge anzuzeigen. Verwenden Sie die Suchleiste, um zu finden, wonach Sie suchen.",
	["BSV2_JET_FLY_CONFIRM"] = "Fliegt in Richtung %s. Genießen Sie Ihren Flug.",
	["BSV2_DISMISS_ALL_TT"] = "Alle Dienste auf einmal ablehnen.",
	["GENERIC_HELP_LABEL"] = "Helfen",
	["GENERIC_LOCATION_ACTION_ERR"] = "Bitte begeben Sie sich an einen geeigneten Ort, bevor Sie diese Aktion durchführen.",
	["GENERIC_ENTITY_SPAWN_FAIL"] = "Entität konnte nicht erstellt werden!",
	["BSV2_ES_NEW_GROUP_HELP_3"] = "Schritt 3: Wählen Sie drei Mitglieder für Ihre Gruppe aus, indem Sie diese Schritte befolgen:",
	["BSV2_ES_NEW_GROUP_HELP_3.1"] = "Wählen Sie ein Ped-Modell aus der Liste aus (die Liste ist gekürzt, Sie können jedoch die Suchleiste verwenden, um jedes Modell zu finden).",
	["BSV2_ES_NEW_GROUP_HELP_3.5"] = "Sie können [-] drücken, um ein Mitglied zu entfernen und es erneut zu versuchen.",
	["BSV2_ES_NEW_GROUP_MEMBERS_DONE"] = "Drücken Sie oben zur Bestätigung auf OK.",
	["BSV2_ES_NEW_GROUP_HELP_1"] = "Schritt 1: Wählen Sie einen Namen für Ihre Gruppe.",
	["BSV2_ES_NEW_GROUP_SUCCESS"] = "Ihre neue Escort-Gruppe wurde erfolgreich gespeichert. Sie finden es im Reiter „Spawner“.",
	["BSV2_ES_NEW_GROUP_NEXT"] = "Drücken Sie %s, um mit dem nächsten Schritt fortzufahren.",
	["BSV2_ES_NEW_GROUP_MEMBERS_REMOVE"] = "Letztes Mitglied entfernen.",
	["BSV2_ES_NEW_GROUP_MEMBERS_ADD"] = "Aktuelles Mitglied hinzufügen.",
	["BSV2_ES_NEW_GROUP_HELP_2"] = "Schritt 2: Wählen Sie ein Fahrzeug aus der Kombinationsliste (Sie müssen mindestens einmal darauf klicken, um ein Modell auszuwählen).",
	["BSV2_ES_NEW_GROUP_HELP_3.2"] = "(Optional): Wählen Sie einen Namen für Ihr Gruppenmitglied. Sie können dieses Feld leer lassen oder auf die Schaltfläche klicken, um einen zufälligen Namen zu generieren.",
	["BSV2_ES_NEW_GROUP_HELP_3.4"] = "Drücken Sie die Taste [+], um diese Schritte für die nächsten Mitglieder zu wiederholen.",
	["BSV2_ES_NEW_GROUP_HELP_4"] = "Sobald alle drei Schritte abgeschlossen sind, können Sie oben rechts im Fenster auf die Schaltfläche [OK] klicken, um Ihre Gruppe zu speichern.",
	["BSV2_ES_NEW_GROUP_HELP_5"] = "TIPP: Sie können jederzeit oben links im Fenster auf [ < ] drücken, um einen Schritt zurückzugehen und Dinge zu ändern.",
	["BSV2_ES_NEW_GROUP_HELP_3.3"] = "(Optional): Wählen Sie eine Waffe für Ihr Gruppenmitglied. Sie können dies ignorieren und stattdessen auf eine taktische Maschinenpistole zurückgreifen.",
	["BSV2_CONFIRM_DELETE_GROUP"] = "Sind Sie sicher, dass Sie diese Gruppe löschen möchten?",
	["BSV2_JET_SPAWN_SUCCESS"] = "Ihr %s wartet bei %s auf Sie",
	["BSV2_JET_DISMISS_ERR"] = "Sie können Ihren Jet nicht mitten in der Luft abwerfen! Springen Sie aus oder bitten Sie Ihren Piloten, zuerst auf einem Flughafen zu landen.",
	["BSV2_HELI_LAND_WATER_ERR"] = "Ihr Helikopter wird nicht landen, weil Sie im Wasser sind.",
	["BSV2_TOO_MANY_GROUPS_WARN"] = "Du bringst zu viele Begleitgruppen hervor!",
	["BSV2_JET_SPAWN_AIRPORT_ERR"] = "Es konnte kein Privatjet angerufen werden! Ungültige Flughafendaten.",
	["YAV3_FLAGS_LOOPING"] = "Geschleift",
	["YAV3_FLAGS_UPPERBODY"] = "Nur Oberkörper",
	["YAV3_FLAGS_SECONDARY"] = "Sekundär",
	["YAV3_FLAGS_HIDE_WEAPON"] = "Waffe verstecken",
	["YAV3_FLAGS_ADDITIVE"] = "Zusatzstoff",
	["YAV3_FLAGS_ENDS_IN_DEAD_POSE"] = "Endet mit dem Tod",
	["YAV3_FLAGS_ALTERNATIVE_FP_ANIM"] = "Alternative First-Person-Animation",
	["YAV3_FLAGS_FORCE_START"] = "Start erzwingen",
	["YAV3_FLAGS_USE_FULL_BLENDING"] = "Verwenden Sie Full Blending",
	["YAV3_FLAGS_NOT_INTERRUPTABLE"] = "Nicht unterbrechbar",
	...
	["GENERIC_YOU"] = "Du",
	["GENERIC_CLASS"] = "Klasse",
	["GENERIC_CLOSE"] = "Schließen",
	["GENERIC_CUSTOMIZE"] = "Anpassen",
	["GENERIC_MANUFACTURER"] = "Hersteller",
	["GENERIC_FAVORITES"] = "Favoriten",
	["EF_MODEL_EXISTS_ERR"] = "Dieses Modell existiert bereits. Bitte wählen Sie eine andere aus.",
	["EF_ALPHA"] = "Transparenz: %d",
	["EF_FAV_SAVE_SUCCESS"] = "%s zu den Favoriten hinzugefügt.",
	["EF_NONE_SPAWNED_HINT"] = "Generieren Sie einige Entitäten, um mit der Erstellung zu beginnen.",
	["EF_TAB_SPAWNER"] = "Spawner",
	["EF_MOUSE_CURSOR_HINT"] = "Drücken Sie [ %s ], um den Mauszeiger %s zu bewegen.",
	["EF_ALPHA_PLAYER_NOT_ALLOWED"] = "Das Ändern der Transparenz ist für die lokale Player-Entität nicht zulässig.",
	["EF_AXIS_WINDOW_TT"] = "Öffnet die Bewegungs- und Rotationssteuerung zur besseren Sichtbarkeit in einem unabhängigen Fenster.",
	["EF_ROTATION_AXIS_HINT"] = "Die Rotation erfolgt relativ zum Befestigungsknochen.",
	["EF_SELF_ATTACH_HINT"] = "Wählen Sie einen Knochen aus der Liste aus und drücken Sie dann die Taste, um die Entität mit sich selbst zu verbinden.",
	["EF_NEW_FORGE_SUCCESS"] = "„%s“ zu den gespeicherten Kreationen hinzugefügt",
	["EF_SPAWNED_ENTITIES"] = "Gespawnte Entitäten",
	["EF_TAB_CREATOR"] = "Schöpfer",
	["EF_PARENT_CANDIDATES"] = "Elternkandidaten",
	["EF_CHILD_CANDIDATES"] = "Kinderkandidaten",
	["EF_CHILD_ITEMS"] = "Untergeordnete Elemente:",
	["EF_AXIS_WINDOW"] = "Achsenfenster",
	["EF_TAB_SPAWNED_ENTITIES"] = "Gespawnte Entitäten",
	...
	["YRV3_HUB_REMOVE_TECH_FAIL_FMT"] = "Techniker konnte nicht aus %s entfernt werden!",
	["YRV3_HUB_SWAP_TECH_WARN_FMT"] = "Ihnen blieb ein nicht zugewiesener Techniker übrig, weil wir ihn nicht dem Quell-Hub neu zuweisen konnten.",
	["YRV3_HUB_TRANSFER_TECH_REL_ONLY"] = "Nur relevant",
	["YRV3_HUB_TRANSFER_TECH_SUCCESS_FMT"] = "Techniker von %s nach %s versetzt.",
	["YRV3_HUB_TRANSFER_TECH_REL_ONLY_TT"] = "Listen Sie nur Unternehmen auf, die weder über ein maximales Produktangebot noch einen zugewiesenen Techniker verfügen.",
	["YRV3_HUB_SWAP_TECH_SUCCESS_FMT"] = "Techniker zwischen %s und %s ausgetauscht.",
	["YRV3_AUTO_PROD_TT"] = "Löst im Laufe der Zeit immer wieder Produktion aus. Deaktiviert sich automatisch, wenn die Produktion das Maximum erreicht.\n\n„Unsichere Funktionen“ müssen aktiviert sein.",
	["YRV3_DANGER_ZONE"] = "[ ! ] Gefahrenzone",
	["YRV3_UNSAFE_FEATS_ENABLED"] = "Unsichere Funktionen aktiviert.",
	["YRV3_UNSAFE_FEATS_CB"] = "Unsichere Funktionen umschalten",
	["YRV3_UNSAFE_FEATS_DISABLED"] = "Unsichere Funktionen deaktiviert.",
	["YRV3_CASH_FILL_TT"] = "Setzt Ihren sicheren Barwert sofort auf max. Kann auch defekte Safes reparieren, die die maximal zulässigen Werte überschreiten.\n\n„Unsichere Funktionen“ müssen aktiviert sein.",
	["YRV3_BULK_SAFE_FILL_SUCCESS_FMT"] = "%d Bargeldtresore bis max. gefüllt",
	["YRV3_CASH_FILL"] = "[ ! ] Bargeld auffüllen",
	["YRV3_BULK_SAFE_FILL_NONE"] = "Es wurden keine Bargeldtresore gefüllt. Either you don't own any safes or they are all full of cash.",
	["YRV3_UNSAFE_FEATS_HINT"] = "[TIPP]: Allen unsicheren Funktionsbezeichnungen wird „[!“ vorangestellt. ]'.",
	["YRV3_UNSAFE_FEAT_BYPASS_ERR"] = "Diese Funktion ist unsicher. Sie müssen „Unsichere Funktionen“ explizit auf der Registerkarte „Einstellungen“ aktivieren, bevor Sie sie verwenden können.",
	["GENERIC_RESET_DEFAULT"] = "Auf Standard zurücksetzen",
	["GENERIC_ALL"] = "Alle",
	["VEH_FLAGS_ADVANCED"] = "Erweiterte Flaggen",
	["VEH_FLAGS_FILTER_ENABLED_ONLY"] = "Nur aktiviert",
	["VEH_FLAGS_FILTER_DISABLED_ONLY"] = "Nur deaktiviert",
	["VEH_FLAGS_WRONG_VEH_TYPE"] = "Nicht unterstützter Fahrzeugtyp.",
	["VEH_FLAGS_BIKES_CARS_ONLY"] = "Es sind nur Autos und Motorräder erlaubt.",
	["VEH_FLAGS_HANDLING"] = "Umgang mit Flags",
	["VEH_FLAGS_MODEL_INFO"] = "Modell-Info-Flags",
	["VEH_FLAGS_MODEL"] = "Modellflaggen",
	["GENERIC_DESCRIPTION"] = "Beschreibung",
	["GENERIC_NO_DESCRIPTION"] = "Keine Beschreibung.",
	["GENERIC_AUTO_APPLY"] = "Automatisch anwenden",
	["GENERIC_AUTO_ENABLE"] = "Automatisch aktivieren",
	["GENERIC_OVERVIEW"] = "Überblick",
	["GENERIC_CARS"] = "Autos",
	["GENERIC_HELIS"] = "Helis",
	["GENERIC_PLANES"] = "Flugzeuge",
	["GENERIC_NAME_ERR"] = "Dieser Name existiert bereits. Bitte wählen Sie ein anderes!",
	["VEH_FLAGS_PRESETS_TAB"] = "Voreinstellungen",
	["VEH_FLAGS_EDITOR_TAB"] = "Editor",
	["VEH_FLAGS_PRESETS_NONE_TXT"] = "Es sind keine gespeicherten Voreinstellungen vorhanden. Im Reiter „Editor“ können Sie neue erstellen.",
	["VEH_FLAGS_NEW_PRESET_VEHICLE_BS"] = "Zulässige Fahrzeugtypen",
	["GENERIC_BIKES"] = "Fahrräder",
	["VEH_FLAGS_DUMP_PRESET_FLAGS"] = "Zugehörige Flags anzeigen",
	["VEH_FLAGS_NEW_PRESET"] = "Als Voreinstellung speichern",
	["GENERIC_BOATS"] = "Boote",
	["VEH_FLAGS_NEW_PRESET_SUCCESS"] = "Die Voreinstellung „%s“ wurde erfolgreich registriert.",
	["VEH_FLAGS_PRESET_NO_DELETE"] = "Standardvoreinstellungen können nicht gelöscht werden.",
	["VEH_FLAGS_FLAG_OWNED_WARN"] = "Dieses Flag kann nicht umgeschaltet werden, da es derzeit einer oder mehreren aktiven Voreinstellungen gehört.",
	["VEH_FLAGS_NO_RESET"] = "Sie können die Bearbeitungsdaten derzeit nicht zurücksetzen, da Sie über aktive automatische Voreinstellungen verfügen.",
	...
	["GENERIC_HELLO"] = "Hallo",
	["GENERIC_YES"] = "Ja",
	["YRV3_HEADER_TITLE"] = "Schnelle Aktionen",
	["YRV3_BANK"] = "Bank:",
	["YRV3_WALLET"] = "Geldbörse:",
	["GENERIC_NO"] = "NEIN",
	["GENERIC_LOCK"] = "Sperren",
	["YRV3_DASHBOARD_FINANCES"] = "Portfolio",
	["YRV3_DASHBOARD_NET_WORTH"] = "Vermögen",
	["GENERIC_LOCK_VAL"] = "Wert sperren",
	["YRV3_MP_CHAR_INDEX"] = "Zeichenindex",
	["SUBTAB_MPSTAT_CONTROLLER"] = "Stat-Controller",
	["YRV3_MP_CHAR_NAME"] = "Charaktername",
	["YRV3_DASHBOARD"] = "Armaturenbrett",
	["YRV3_DASHBOARD_FUNDS_WALLET"] = "Geldbörse",
	...
	["YRV3_OFFICE_CLUTTER_LABEL"] = "Unordnung im Büro",
	["YRV3_OFFICE_CLUTTER_AUTO_CLEAR_TT"] = "Bereinigt Ihr Büro automatisch von allen ausgewählten Unordnungsgegenständen.",
	["YRV3_OFFICE_CLUTTER_AUTO_CLEAR"] = "Automatisches Löschen",
	["YRV3_OFFICE_CLUTTER_CUNS"] = "Waffen",
	["YRV3_OFFICE_CLUTTER_SILVER"] = "Silber",
	["YRV3_OFFICE_CLUTTER_ITEM_SELECT"] = "Zu löschende Elemente:",
	["YRV3_OFFICE_CLUTTER_ELECTRONICS"] = "Elektronik",
	["YRV3_OFFICE_CLUTTER_CASH"] = "Kasse",
	["YRV3_OFFICE_CLUTTER_MEDS"] = "Medikamente",
	["YRV3_OFFICE_CLUTTER_IVORY"] = "Elfenbein",
	["YRV3_OFFICE_CLUTTER_JEWEL"] = "Schmuck",
	["YRV3_OFFICE_CLUTTER_GEMS"] = "Edelsteine",
	["YRV3_OFFICE_CLUTTER_PILLS"] = "Pillen",
	["YRV3_OFFICE_CLUTTER_DRUGSTATUES"] = "Drogenstatuen",
	["YRV3_OFFICE_CLUTTER_FURCOATS"] = "Pelzmäntel",
	["YRV3_OFFICE_CLUTTER_DRUGBAGS"] = "Drogentaschen",
	["YRV3_OFFICE_CLUTTER_COUNTERFEIT"] = "Gefälschte Artikel",
	["YRV3_OFFICE_CLUTTER_ART"] = "Kunstwerk",
	["YRV3_OFFICE_CLUTTER_BOOZE"] = "Alkohol und Zigaretten",
	["YRV3_DASHBOARD_BOSS_ASSOCIATE"] = "Assoziieren",
	["GENERIC_DRIVING_COMMANDS"] = "Fahrstil",
	["GENERIC_RESUME"] = "Wieder aufnehmen",
	["YRV3_DASHBOARD_BOSS_ASSOCIATE_ERR"] = "Sie können sich nicht als Chef registrieren lassen, während Sie für jemand anderen arbeiten.",
	["YH_CAYO_TROJAN"] = "Standort des Lieferwagens",
	["YH_GENERIC_CD_LABEL"] = "Abklingzeit deaktivieren",
	["YH_APPROACH_VEHICLE"] = "Annäherungsfahrzeug",
	["YH_VIEW_BOOSTS"] = "Wöchentliche Boosts",
	["YH_GENERIC_PROPERTY"] = "Operationsbasis",
	["YH_BOOST_STATUS"] = "Boost-Status:",
	["YH_REQUIRED_PROPERTY_ERR_FMT"] = "Kaufen Sie ein %s, um auf das %s zuzugreifen",
	["CP_HEIST_PLAYER_CUTS"] = "Spielerkürzungen",
	["YH_SECONDARY_TARGET_TXT"] = "Sekundäre Ziele werden automatisch festgelegt, wenn die Schaltfläche „Bestätigen“ gedrückt wird. Dies geschieht, um eine Störung der Beutelogik zu vermeiden.",
	["YH_REQUIRED_PROPERTY_ERR"] = "Sie besitzen nicht das für diesen Raubüberfall erforderliche Grundstück!",
	["YH_SUBTITLE_TXT"] = "Richten Sie Ihre Raubüberfälle nach Ihren Wünschen ein und klicken Sie dann unten auf die Schaltfläche „Bestätigen“.",
	["GENERIC_PLAYER_FMT"] = "Spieler %s",
	["YH_SKIP_OBJECTIVE"] = "Ziel überspringen",
	["YH_GENERIC_SKIP_PREPS_TT"] = "Alle sekundären Ziele wurden abgeschlossen.",
	["GENERIC_SESSION_REFRESH_NOTIF"] = "Bitte treten Sie einer neuen Sitzung bei, damit die Änderungen wirksam werden.",
	["YH_SKIP_OBJECTIVE_TT"] = "Versucht, das aktuelle Ziel zu überspringen. Kann verwendet werden, um den Casino-Überfall nur mit Doppelschlüsselkarten zu bestehen.\n\n[HINWEIS]: Funktioniert möglicherweise nicht mit allen Überfällen.",
	["YH_GENERIC_SKIP_PREPS"] = "Überspringen Sie die Vorbereitungen",
	["YH_FINISH_MISSION_TT"] = "Versucht, die aktuelle Mission sofort zu beenden. Funktioniert möglicherweise nicht mit allen Missionen/Raubüberfällen.",
	["YH_LOAD_ERR"] = "Etwas ist schief gelaufen! Bitte laden Sie das Skript neu, wenn Sie sich in einer Freemode-Sitzung befinden.",
	["YH_FINISH_MISSION"] = "Sofortiges Finish",
	["YH_FAIL_MISSION"] = "Mission scheitern",
	["YH_TP_CH_LOADING_BAY"] = "Ladebucht",
	["YH_TP_CH_UTIL_RM"] = "Hauswirtschaftsraum",
	["YH_TP_CH_VAULT"] = "Gewölbe",
	["YH_TP_CH_MANTRAP"] = "Falle",
	["YH_TP_CH_BASEMENT"] = "Unterstufe (B1)",
	["YH_TP_CH_CASH_ROOM"] = "Kleiner Kassenraum",
	["YH_TP_CH_ELEV_SHAFT"] = "Aufzugsschacht",
	["YH_DDAY_SELECTED_ACT"] = "Ausgewähltes Gesetz",
