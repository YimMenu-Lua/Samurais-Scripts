return {
	...
	["GENERIC_CLOSE"]                      = "Close",
	["GENERIC_APPLY"]                      = "Apply",
	["GENERIC_AUTO_APPLY"]                 = "Auto-Apply",
	["GENERIC_AUTO_ENABLE"]                = "Auto-Enable",
	["GENERIC_RETRY"]                      = "Retry",
	["GENERIC_RESET"]                      = "Reset",
	["GENERIC_RESET_ALL"]                  = "Reset All",
	["GENERIC_RESET_DEFAULT"]              = "Reset To Default",
	...
	["GENERIC_KILL"]                       = "Kill",
	["GENERIC_GOTO"]                       = "Go To",
	["GENERIC_WANDER"]                     = "Wander",
	["GENERIC_WARP_INTO_VEH"]              = "Warp Into Vehicle",
	["GENERIC_INTERIOR_ACTION_ERR"]        = "This action is not allowed inside interiors.",
	["GENERIC_LOCATION_ACTION_ERR"]        = "Please go to a suitable location before performing this action.",
	["GENERIC_ENTITY_SPAWN_FAIL"]          = "Failed to create entity!",
	...
	["GENERIC_DISMISS_ALL"]                = "Dismiss All",
	["GENERIC_LIST_SORT"]                  = "Sort",
	...
	["GENERIC_NO_DESCRIPTION"]             = "No description.",
	["GENERIC_OVERVIEW"]                   = "Overview",
	["GENERIC_CARS"]                       = "Cars",
	["GENERIC_BIKES"]                      = "Bikes",
	["GENERIC_BOATS"]                      = "Boats",
	["GENERIC_HELIS"]                      = "Helis",
	["GENERIC_PLANES"]                     = "Planes",
	["GENERIC_NAME_ERR"]                   = "This name already exists. Please choose a different one!",
	["GENERIC_DATA_PARSE_FAIL"]            = "Failed to parse data! Please try again later.",
	["GENERIC_CLIPBOARD_COPY"]             = "Copy To Clipboard",
	...
	["YRV3_AUTO_PROD"]                     = "[ ! ] Production Loop",
	["YRV3_AUTO_PROD_TT"]                  = "Keeps triggering production over time. Automatically disables itself when production reaches max.\n\nMust have 'Unsafe Features' enabled.",
	["YRV3_AUTO_SELL"]                     = "Auto-Sell",
	["YRV3_AUTO_SELL_COUNTDOWN"]           = "'Auto-Sell' will start in 20 seconds. You can cancel it before the timer ends by either disabling the feature or clicking this notification.",
	["YRV3_AUTO_SELL_CANCELED_MSG"]        = "'Auto-Sell' has been canceled.",
	...
	["YRV3_TRIGGER_PROD_TT"]               = "Instantly triggers production once as long as you have supplies. You can hold the button to keep triggering it or enable 'Production Loop' to fully automate the process.\n\nMust have 'Unsafe Features' enabled.",
	["YRV3_TRIGGER_PROD_HUB_TT"]           = "Keeps triggering production over time. You must make sure the connected business is setup and running and you have a technician assigned to this hub.\n\nMust have 'Unsafe Features' enabled.",
	["YRV3_HUB_TECH_NOT_ASSIGNED_TT"]      = "No technician is assigned to this hub.",
	["YRV3_HUB_TRANSFER_TECH"]             = "[ ! ] Transfer Technician",
	["YRV3_HUB_TRANSFER_TECH_REL_ONLY"]    = "Relevant Only",
	["YRV3_HUB_REMOVE_TECH_FAIL_FMT"]      = "Failed to remove technician from %s!",
	["YRV3_HUB_TRANSFER_TECH_FAIL_FMT"]    = "Failed to transfer technician from %s to %s!",
	["YRV3_HUB_SWAP_TECH_WARN_FMT"]        = "You were left with one unassigned technician because we failed to re-assign it to the source hub.",
	["YRV3_HUB_TRANSFER_TECH_SUCCESS_FMT"] = "Transferred technician from %s to %s.",
	["YRV3_HUB_SWAP_TECH_SUCCESS_FMT"]     = "Swapped technicians between %s and %s.",
	["YRV3_HUB_TRANSFER_TECH_REL_ONLY_TT"] = "Only list businesses that neither have maximum product nor an assigned technician.",
	...
	["YRV3_AUTOSELL_NC_CARGO_LABEL"]       = "Nightclub Cargo",
	["YRV3_AUTOSELL_LSD_LAB_LABEL"]        = "Acid Lab (Temporarily Disabled)",
	...
	["YRV3_HANGAR_LAND_ERR"]               = "Hangar land sales are currently not supported.",
	["YRV3_AUTO_SELL_MANUAL"]              = "Manually Finish Sale",
	["YRV3_AUTO_FILL_DELAY"]               = "Global Auto-Fill delay:",
	["YRV3_DANGER_ZONE"]                   = "[ ! ] Danger Zone",
	...
	["YRV3_CASH_FILL_TT"]                  = "Instantly sets your safe cash value to max. Can also fix broken safes that exceed the maximum allowed values.\n\nMust have 'Unsafe Features' enabled.",
	...
	["YRV3_BULK_SAFE_FILL_NONE"]           = "No cash safes were filled. Either you don't own any safes or they are all full of cash.",
	["YRV3_BULK_SAFE_FILL_SUCCESS_FMT"]    = "Filled %d cash safes to max.",
	["YRV3_OFFICE_CLUTTER_LABEL"]          = "Office Clutter",
	["YRV3_OFFICE_CLUTTER_AUTO_CLEAR"]     = "Auto Clear",
	["YRV3_OFFICE_CLUTTER_AUTO_CLEAR_TT"]  = "Automatically clears your office from all selected clutter items.",
	["YRV3_OFFICE_CLUTTER_ITEM_SELECT"]    = "Items To Clear:",
	["YRV3_OFFICE_CLUTTER_CASH"]           = "Cash",
	["YRV3_OFFICE_CLUTTER_SILVER"]         = "Silver",
	["YRV3_OFFICE_CLUTTER_PILLS"]          = "Pills",
	["YRV3_OFFICE_CLUTTER_MEDS"]           = "Meds",
	["YRV3_OFFICE_CLUTTER_JEWEL"]          = "Jewelry",
	["YRV3_OFFICE_CLUTTER_IVORY"]          = "Ivory",
	["YRV3_OFFICE_CLUTTER_CUNS"]           = "Weapons",
	["YRV3_OFFICE_CLUTTER_GEMS"]           = "Gems",
	["YRV3_OFFICE_CLUTTER_FURCOATS"]       = "Fur Coats",
	["YRV3_OFFICE_CLUTTER_ELECTRONICS"]    = "Electronics",
	["YRV3_OFFICE_CLUTTER_DRUGSTATUES"]    = "Drug Statues",
	["YRV3_OFFICE_CLUTTER_DRUGBAGS"]       = "Drug Bags",
	["YRV3_OFFICE_CLUTTER_COUNTERFEIT"]    = "Counterfeit Items",
	["YRV3_OFFICE_CLUTTER_BOOZE"]          = "Alcohol & Cigarettes",
	["YRV3_OFFICE_CLUTTER_ART"]            = "Artwork",
	--#endregion
	...
	["SELF_MC_BIKE_ANIMS_TT"]              = "Enables alternate bike riding animations.",
	...
	["VEH_FLAGS_HANDLING"]                 = "Handling Flags",
	["VEH_FLAGS_MODEL"]                    = "Model Flags",
	["VEH_FLAGS_MODEL_INFO"]               = "Model Info Flags",
	["VEH_FLAGS_BIKES_CARS_ONLY"]          = "Only cars and motorcycles are allowed.",
	["VEH_FLAGS_WRONG_VEH_TYPE"]           = "Unsupported vehicle type.",
	["VEH_FLAGS_NO_RESET"]                 = "You can not reset handling data at the moment because you have active automatic presets.",
	["VEH_FLAGS_FLAG_OWNED_WARN"]          = "This flag can not be toggled as it is currently owned by one or more active presets.",
	["VEH_FLAGS_PRESET_NO_DELETE"]         = "Default presets can not be deleted.",
	["VEH_FLAGS_PRESET_NO_SHARE"]          = "Default presets can not be shared as they are the same for everyone.",
	["VEH_FLAGS_PRESET_SHARE_SUCCESS_FMT"] = "Preset '%s' has been copied to your clipbloard and logged to console. Other script users can import the preset by pasting the data in the 'Import' window.",
	["VEH_FLAGS_PRESET_FILTER_CARS_ONLY"]  = "Cars Only",
	["VEH_FLAGS_PRESET_PARSER_TOOLTIP"]    = "The preset will be displayed here once valid data has been decoded.",
	["VEH_FLAGS_PRESET_IMPORT_FAIL"]       = "Failed to import preset. Please try again later.",
	["VEH_FLAGS_PRESET_IMPORT_SUCCESS"]    = "New preset has been successfully imported.",
	["VEH_FLAGS_PRESET_FILTER_BIKES_ONLY"] = "Bikes Only",
	["VEH_FLAGS_PRESET_FILTER_BOTH"]       = "Cars And Bikes",
	["VEH_FLAGS_DUMP_PRESET_FLAGS"]        = "View Associated Flags",
	["VEH_FLAGS_NEW_PRESET_LABEL"]         = "New Preset",
	["VEH_FLAGS_NEW_PRESET_WARN"]          = "You currently have one or more active presets. Generating a new one will include all flags that have been changed by the active preset(s).\n\nAre you sure you would like to proceed anyway?",
	["VEH_FLAGS_NEW_PRESET_ERR"]           = "A preset with the same name already exists!",
	["VEH_FLAGS_AUTOENABLE_TT"]            = "This preset will be automatically enabled as soon as you enter a new vehicle. You can still disable a preset while having 'Auto-Enable' on but it will only re-enable itself once you change vehicles (respawn your vehicle, reload the script, or get in a different vehicle).",
	["VEH_NO_ENGINE_BRAKE"]                = "No Engine Brake",
	["VEH_NO_ENGINE_BRAKE_TT"]             = "Allows you to coast when not pressing the accelerator without losing so much speed.",
	["VEH_WHEELIE"]                        = "Wheelie",
	["VEH_WHEELIE_TT"]                     = "CARS ONLY: Gives you the ability to perform wheelies in any car just like default muscle cars: Hold 'Handbrake' + 'Accelerate' for a few seconds then release the handbrake.",
	...
	["VEH_OFFROAD_ABILITIES_TT"]           = "Works side by side with 'Stancer' to increase your vehicle's offroad capabilities: Raises ride height, widens track width, forces smooth RPM, locks front and rear differentials, etc.\n\nPS: It is recommended to have the 'Fast Vehicles' option in the main vehicle tab enabled (can be toggled using the 'fastvehs' command).",
	["VEH_FORCE_NO_TC"]                    = "No Traction Control",
	["VEH_FORCE_NO_TC_TT"]                 = "Forces your vehicle to have no traction or stability control.\nWith this enabled, bikes will also be able to slide and drift.",
	...
	["VEH_JUMP_TT"]                        = "Equips your vehicle with jump capability, similar to the 'Ruiner 2000'. While driving, press [E] to jump in the air then press [SPACE] to deploy a parachte.",
	["VEH_RAMP"]                           = "Ramp Mod",
	["VEH_RAMP_TT"]                        = "Equips your vehicle with a ramp mod (not visible) and gives it a big ramming force against all vehicles, essentially making it unstoppable.",
	...
	["YAV3_ANIM_HISTORY_TT"]               = "Animations, scenarios, and scenes you play will appear here.",
	["YAV3_DISABLE_PROPS"]                 = "Disable Props",
	["YAV3_DISABLE_PTFX"]                  = "Disable Particle Effects",
	["YAV3_DISABLE_SFX"]                   = "Disable Sound Effects",
	["YAV3_FLAGS_LOOPING"]                 = "Looped",
	["YAV3_FLAGS_UPPERBODY"]               = "Upper Body Only",
	["YAV3_FLAGS_SECONDARY"]               = "Secondary",
	["YAV3_FLAGS_HIDE_WEAPON"]             = "Hide Weapon",
	["YAV3_FLAGS_ENDS_IN_DEAD_POSE"]       = "Ends With Death",
	["YAV3_FLAGS_HOLD_LAST_FRAME"]         = "Hold Last Frame",
	["YAV3_FLAGS_NOT_INTERRUPTABLE"]       = "Not Interruptible",
	["YAV3_FLAGS_ADDITIVE"]                = "Additive",
	["YAV3_FLAGS_TURN_OFF_COLLISION"]      = "Disable Collision",
	["YAV3_FLAGS_FORCE_START"]             = "Force Start",
	["YAV3_FLAGS_PROCESS_ATTACHMENTS"]     = "Process Attachments",
	["YAV3_FLAGS_ALTERNATIVE_FP_ANIM"]     = "Alternate First Person Anim",
	["YAV3_FLAGS_USE_FULL_BLENDING"]       = "Use Full Blending",
	["YAV3_FLAGS_DEAD_POSE_LOOPED_TT"]     = "This will not do anything if the animation is looped.",
	--#endregion
	...
	["BSV2_BODYGUARDS_LABEL"]              = "Bodyguards",
	["BSV2_ESCORTS_LABEL"]                 = "Escorts",
	["BSV2_LIMO_LABEL"]                    = "Limousine",
	["BSV2_HELI_LABEL"]                    = "Helicopter",
	["BSV2_JET_LABEL"]                     = "Jet",
	["BSV2_WEAPONS_LABEL"]                 = "Weapons",
	["BSV2_GIVE_ALL_WEAPONS"]              = "Give All Weapons",
	["BSV2_BG_SPAWNED_TAB"]                = "Active Bodyguards",
	["BSV2_ES_SPAWNED_TAB"]                = "Active Groups",
	["BSV2_BG_SPAWNED_NONE"]               = "You haven't dispatched any bodyguards.",
	["BSV2_ES_SPAWNED_NONE"]               = "You haven't dispatched any escort groups.",
	["BSV2_CALL"]                          = "Call",
	["BSV2_DISPATCH"]                      = "Dispatch",
	["BSV2_ES_BRING_INTERIOR_ERR"]         = "You can not bring escort groups to interiors.",
	["BSV2_ES_GENERIC_CAR_ERR"]            = "Unable to perform action! One or more escort group members failed to get in the vehicle.",
	["BSV2_ES_TP_ERR"]                     = "You must be outside and standing on foot to teleport to your escort group.",
	["BSV2_ES_VEH_INVALID_ERR"]            = "The escort vehicle seems to no longer exist.",
	["BSV2_ES_DRIVING_OPTIONS"]            = "Driving Options",
	["BSV2_ES_DRIVE_WP"]                   = "Drive To Waypoint",
	["BSV2_ES_DRIVE_OBJ"]                  = "Drive To Objective",
	["BSV2_ES_DRIVE_PROPERTY"]             = "Owned Properties",
	["BSV2_ES_DRIVE_PROPERTY_TEXT"]        = "Click on a property to travel to it.",
	["BSV2_ES_NEW_GROUP_NEXT"]             = "Pres %s to proceed to the next step.",
	["BSV2_ES_NEW_GROUP_PROMPT"]           = "Are you sure you want to create group %s ?",
	["BSV2_ES_NEW_GROUP_STEP_LABEL"]       = "Step %d / 3",
	["BSV2_ES_NEW_GROUP_NAME"]             = "Choose a name for your group",
	["BSV2_ES_NEW_GROUP_NAME_ERR"]         = "A group with this name already exists. Please choose a different one.",
	["BSV2_ES_NEW_GROUP_VEH"]              = "Choose a suitable vehicle for your group",
	["BSV2_ES_NEW_GROUP_MEMBERS"]          = "Add new members to your group (no more than 3).",
	["BSV2_ES_NEW_GROUP_MEMBERS_COUNT"]    = "Members: %d / 3",
	["BSV2_ES_NEW_GROUP_MEMBERS_ADD"]      = "Add current member.",
	["BSV2_ES_NEW_GROUP_MEMBERS_REMOVE"]   = "Remove last member.",
	["BSV2_ES_NEW_GROUP_PED_MODEL"]        = "Member Model",
	["BSV2_ES_NEW_GROUP_PED_NAME"]         = "Member Name",
	["BSV2_ES_NEW_GROUP_PED_WEAPON"]       = "Member Weapon",
	["BSV2_ES_NEW_GROUP_MEMBERS_DONE"]     = "Press OK at the top to confirm.",
	["BSV2_ES_NEW_GROUP_SUCCESS"]          = "Your new escort group has been successfully saved. You can find it in the 'Spawner' tab.",
	["BSV2_ES_NEW_GROUP_HELP_1"]           = "Step 1: Pick a name for your group.",
	["BSV2_ES_NEW_GROUP_HELP_2"]           = "Step 2: Choose a vehicle from the combo list (you must click it at least once to select a model).",
	["BSV2_ES_NEW_GROUP_HELP_3"]           = "Step 3: Pick 3 members for your group following these steps:",
	["BSV2_ES_NEW_GROUP_HELP_3.1"]         = "Select a ped model from the list (the list is truncated but you can use the search bar to find any model).",
	["BSV2_ES_NEW_GROUP_HELP_3.2"]         = "(Optional): Pick a name for your group member. You can leave this empty or press the button to generate a random name.",
	["BSV2_ES_NEW_GROUP_HELP_3.3"]         = "(Optional): Pick a weapon for your group member. You can ignore this to default to a tactical SMG.",
	["BSV2_ES_NEW_GROUP_HELP_3.4"]         = "Press the [ + ] button to repeat these steps for the next members.",
	["BSV2_ES_NEW_GROUP_HELP_3.5"]         = "You can press [ - ] to remove a member and retry.",
	["BSV2_ES_NEW_GROUP_HELP_4"]           = "Once all 3 steps are complete, you can press the [ OK ] button at the top right of the window to save your group.",
	["BSV2_ES_NEW_GROUP_HELP_5"]           = "TIP: You can always press [ < ] at the top left of the window to go one step back and change things around.",
	["BSV2_LIMO_MODELS_AVAIL"]             = "Available Limousines",
	["BSV2_LIMO_MORE_OPTS_TT"]             = "Get in the limousine to see more options.",
	["BSV2_LIMO_TAKE_CTRL"]                = "Take Control",
	["BSV2_LIMO_TAKE_CTRL_TT"]             = "Allows you to remotely control the limousine from the comfort of your backseat.",
	["BSV2_LIMO_GIVE_CTRL"]                = "Give Back Control",
	["BSV2_LIMO_GIVE_CTRL_TT"]             = "Give control of the limousine back to the chauffeur.",
	["BSV2_SEAT_CTRL"]                     = "Seat Controls",
	["BSV2_SEAT_CTRL_PREV"]                = "Previous Seat",
	["BSV2_SEAT_CTRL_NEXT"]                = "Next Seat",
	["BSV2_RADIO_CTRL"]                    = "Radio Controls",
	["BSV2_HELI_MODELS_AVAIL"]             = "Available Helicopters",
	["BSV2_HELI_MORE_OPTS_TT"]             = "Get in the helicopter to see more options.",
	["BSV2_HELI_HOVER_HERE"]               = "Hover Here",
	["BSV2_HELI_LAND_HERE"]                = "Land Here",
	["BSV2_FLY_WP"]                        = "Fly To Waypoint",
	["BSV2_FLY_OBJ"]                       = "Fly To Objective",
	["BSV2_FLY_SKIP"]                      = "Skip Trip",
	["BSV2_HELI_RAPPELL"]                  = "Rappell Down",
	["BSV2_HELI_RAPPELL_SEAT_ERR"]         = "You can not rappell down from this seat. Please switch to one of the back seats!",
	["BSV2_HELI_PRESETS"]                  = "Preset Destinations",
	["BSV2_JET_MODELS_AVAIL"]              = "Available Jets",
	["BSV2_AIRPORTS"]                      = "Airports",
	["BSV2_JET_TOO_FAR_WARN"]              = "[NOTE]: Calling the jet while too far away from the airport may cause it to become invisible. Either use the button in this UI to directly warp into the jet (which will force it to become visible) or just call your jet when you're close to the airport.",
	["BSV2_JET_MORE_OPTS_TT"]              = "Get in the jet to see more options.",
	["BSV2_JET_SKIP_LANDING"]              = "Skip Landing",
	["BSV2_JET_LANDING_DEST"]              = "Landing Destinations",
	["BSV2_JET_LANDING_SAME_AP_ERR"]       = "You are already at %s.",
	["BSV2_JET_FLY_CONFIRM"]               = "Flying towards %s. Enjoy your flight.",
	["BSV2_DISMISS_ALL_TT"]                = "Dismiss all services at once.",
	["BSV2_TOO_MANY_GROUPS_WARN"]          = "You're spawning too many escort groups!",
	["BSV2_HELI_LAND_WATER_ERR"]           = "Your helicopter will not land because you're in the water.",
	["BSV2_JET_SPAWN_AIRPORT_ERR"]         = "Failed to call a private jet! Invalid airport data.",
	["BSV2_JET_SPAWN_SUCCESS"]             = "Your %s is waiting for you at %s",
