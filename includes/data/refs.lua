...
HF                       = {
  ...
  _NO_REVERSE                                = 512,
  _REDUCED_RIGHTING_FORCE                    = 1024,
  _REDUCED_RIGHTING_FORCE                    = 1024,
  _STEER_NO_WHEELS                           = 2048,
  _CVT                                       = 4096,
  _ALT_EXT_WHEEL_BOUNDS_BEH                  = 8192,
  _DONT_RAISE_BOUNDS_AT_SPEED                = 16384,
  _EXT_WHEEL_BOUNDS_COL                      = 32768,
  _LESS_SNOW_SINK                            = 65536,
  _TYRES_CAN_CLIP                            = 131072,
  _REDUCED_DRIVE_OVER_DAMAGE                 = 262144,
  _ALT_EXT_WHEEL_BOUNDS_SHRINK               = 524288,
  _OFFROAD_ABILITIES                         = 1048576,
  _OFFROAD_ABILITIES_X2                      = 2097152,
  _TYRES_RAISE_SIDE_IMPACT_THRESHOLD         = 4194304,
  _OFFROAD_INCREASED_GRAVITY_NO_FOLIAGE_DRAG = 8388608,
  _ENABLE_LEAN                               = 16777216,
  _FORCE_NO_TC_OR_SC                         = 33554432,
  _HEAVYARMOUR                               = 67108864,
  _ARMOURED                                  = 134217728,
  _SELF_RIGHTING_IN_WATER                    = 268435456,
  IMPROVED_RIGHTING_FORCE                    = 536870912,
...
AF = {
  _LOOPING                          = 1,
  _HOLD_LAST_FRAME                  = 2,
  _REPOSITION_WHEN_FINISHED         = 4,
  _NOT_INTERRUPTABLE                = 8,
  _UPPERBODY                        = 16,
  _SECONDARY                        = 32,
  _REORIENT_WHEN_FINISHED           = 64,
  _ABORT_ON_PED_MOVEMENT            = 128,
  _ADDITIVE                         = 256,
  _TURN_OFF_COLLISION               = 512,
  _OVERRIDE_PHYSICS                 = 1024,
  _IGNORE_GRAVITY                   = 2048,
  _EXTRACT_INITIAL_OFFSET           = 4096,
  _EXIT_AFTER_INTERRUPTED           = 8192,
  _TAG_SYNC_IN                      = 16384,
  _TAG_SYNC_OUT                     = 32768,
  _TAG_SYNC_CONTINUOUS              = 65536,
  _FORCE_START                      = 131072,
  _USE_KINEMATIC_PHYSICS            = 262144,
  _USE_MOVER_EXTRACTION             = 524288,
  _HIDE_WEAPON                      = 1048576,
  _ENDS_IN_DEAD_POSE                = 2097152,
  _ACTIVATE_RAGDOLL_ON_COLLISION    = 4194304,
  _DONT_EXIT_ON_DEATH               = 8388608,
  _ABORT_ON_WEAPON_DAMAGE           = 16777216,
  _DISABLE_FORCED_PHYSICS_UPDATE    = 33554432,
  _PROCESS_ATTACHMENTS_ON_START     = 67108864,
  _EXPAND_PED_CAPSULE_FROM_SKELETON = 134217728,
  _USE_ALTERNATIVE_FP_ANIM          = 268435456,
  _BLENDOUT_WRT_LAST_FRAME          = 536870912,
  _USE_FULL_BLENDING                = 1073741824,
}
...
-- pets_T = {
--   {hash = 0xE71D5E68, name = "Black Panther",    id = "panther"},
--   {hash = 0x5C9D564B, name = "Bunny",            id = "rabbit"},
--   {hash = 0x573201B8, name = "Cat",              id = "cat"},
--   {hash = 0xA8683715, name = "Chimp",            id = "monkey"},
--   {hash = 0x1250D7BA, name = "Cougar",           id = "cougar"},
--   {hash = 0x349F33E1, name = "Golden Retriever", id = "retriever"},
--   {hash = 0x4E8F95A2, name = "Husky",            id = "husky"},
--   {hash = 0xC2D06F53, name = "Macaque",          id = "monkey"},
--   {hash = 0xB11BAB56, name = "Pig",              id = "pig"},
--   {hash = 0x431D501C, name = "Poodle",           id = "pug"},
--   {hash = 0x6D362854, name = "Pug",              id = "pug"},
--   {hash = 0x14EC17EA, name = "Rottweiler",       id = "rottweiler"},
--   {hash = 0x431FC24C, name = "Shepherd",         id = "retriever"},
--   {hash = 0xAD7844BB, name = "Westie",           id = "pug"},
-- }
