...
Labels = {
  ...
  ["triggerbot_tt"] = {
    { iso = "en-US", text = "A barebones triggerbot that uses game natives. No hackery involved.\10\10Press " .. KBM_TRIGGERBOT_BUTTON .. " on keyboard or " .. GPAD_TRIGGERBOT_BUTTON .. " on controller while aiming at a ped to automatically shoot them in the head. Only works on foot." },
    { iso = "de-DE", text = "Ein Triggerbot, der 'native Elemente' (RAGE natives) des Spiels verwendet. Keine Hacks involviert.\10\10Drücke die " .. KBM_TRIGGERBOT_BUTTON .. " auf der Tastatur oder  " .. GPAD_TRIGGERBOT_BUTTON .. " auf dem Controller, während des Zielen auf einen NPC, um diesen automatisch in den Kopf zu schießen. Funktioniert nur zu Fuß." },
    { iso = "fr-FR", text = "Un triggerbot minimaliste qui utilise les natifs du jeu (RAGE natives). Aucun piratage n'est impliqué.\10\10Appuyez sur " .. KBM_TRIGGERBOT_BUTTON .. " sur le clavier ou " .. GPAD_TRIGGERBOT_BUTTON .. " sur le contrôleur tout en visant un piéton pour lui tirer automatiquement une balle dans la tête. Ne fonctionne qu'à pied." },
    { iso = "it-IT", text = "Un triggerbot essenziale che usa i nativi del gioco. Nessun hackeraggio coinvolto.\10\10Premi " .. KBM_TRIGGERBOT_BUTTON .. " sulla tastiera o " .. GPAD_TRIGGERBOT_BUTTON .. " sul controller mentre miri a un pedone per sparargli automaticamente alla testa. Funziona solo a piedi." },
    { iso = "pt-BR", text = "Um triggerbot simples que usa nativos do jogo. Não há hackers envolvidos.\10\10Pressione " .. KBM_TRIGGERBOT_BUTTON .. " no teclado ou " .. GPAD_TRIGGERBOT_BUTTON .. " no controle ao mirar em um pedestre para atirar automaticamente na cabeça dele. Só funciona a pé." },
    { iso = "ru-RU", text = "Базовый триггербот, использующий нативные игровые возможности. Никакого хакерства.\10\10Нажмите " .. KBM_TRIGGERBOT_BUTTON .. " на клавиатуре или " .. GPAD_TRIGGERBOT_BUTTON .. " на контроллере, нацелившись на пешехода, чтобы автоматически выстрелить ему в голову. Работает только на ногах." },
  },
  ...
  ["katanaCB"] = {
    { iso = "en-US", text = "Katana" },
    { iso = "de-DE", text = "Katana" },
    { iso = "fr-FR", text = "Katana" },
    { iso = "it-IT", text = "Katana" },
    { iso = "pt-BR", text = "Katana" },
    { iso = "ru-RU", text = "Katana" },
  },
  ...
  ["driftMode_tt"] = {
    { iso = "en-US", text = "This will make your car lose grip. Hold " .. DRIFT_BUTTON .. " to drift." },
    { iso = "de-DE", text = "Das Fahrzeug verliert dadurch die Bodenhaftung. Halte " .. DRIFT_BUTTON .. " gedrückt, um zu driften." },
    { iso = "fr-FR", text = "Cela fera perdre l'adhérence à votre voiture. Maintenez la touche " .. DRIFT_BUTTON .. " pour drifter." },
    { iso = "it-IT", text = "Questo farà perdere aderenza alla tua auto. Tieni premuto " .. DRIFT_BUTTON .. " per andare alla deriva." },
    { iso = "pt-BR", text = "Isso fará com que seu carro perca a aderência. Mantenha pressionada a tecla " .. DRIFT_BUTTON .. " para fazer drift." },
    { iso = "ru-RU", text = "Это приведет к потере сцепления c дорогой. Удерживайте " .. DRIFT_BUTTON .. ", чтобы дрифтовать." },
  },
  ...
  ["driftTires_tt"] = {
    { iso = "en-US", text = "This will equip your car with drift tires whenever you press " .. DRIFT_BUTTON .. ". Your tires will be reset when you release the button." },
    { iso = "de-DE", text = "Dadurch wird das Fahrzeug mit Drift-Reifen ausgestattet, wenn die " .. DRIFT_BUTTON .. " gedrückt wird. Die Reifen werden wiederhergestellt, wenn die Taste losgelassen wird." },
    { iso = "fr-FR", text = "Cela équipera votre voiture de pneus de drift lorsque vous appuierez sur " .. DRIFT_BUTTON .. ". Vos pneus seront réinitialisés lorsque vous relâcherez le bouton." },
    { iso = "it-IT", text = "Questo equipaggerà l'auto con pneumatici da drift quando si preme " .. DRIFT_BUTTON .. ". I pneumatici verranno ripristinati quando si rilascia il pulsante." },
    { iso = "pt-BR", text = "Isso equipará seu carro com pneus de drift sempre que você pressionar " .. DRIFT_BUTTON .. ". Seus pneus serão zerados quando você soltar o botão." },
    { iso = "ru-RU", text = "Это позволит оснастить автомобиль дрифтовыми шинами при каждом нажатии кнопки " .. DRIFT_BUTTON .. ". Шины будут сброшены, когда вы отпустите кнопку." },
  },
  ...
  ["purge_tt"] = {
    { iso = "en-US", text = "Press " .. KBM_PURGE_BUTTON .. " on keyboard or " .. GPAD_PURGE_BUTTON .. " on controller to purge your NOS Fast & Furious style." },
    { iso = "de-DE", text = "Drücken " .. KBM_PURGE_BUTTON .. " oder " .. GPAD_PURGE_BUTTON .. " auf dem Controller, um das NOS im Fast & Furious-Stil zu entleeren." },
    { iso = "fr-FR", text = "Appuyez sur " .. KBM_PURGE_BUTTON .. " sur le clavier ou " .. GPAD_PURGE_BUTTON .. " sur le contrôleur pour purger votre NOS à la Fast & Furious." },
    { iso = "it-IT", text = "Premi " .. KBM_PURGE_BUTTON .. " sulla tastiera o " .. GPAD_PURGE_BUTTON .. " sul controller per purgare il tuo NOS alla stile Fast & Furious." },
    { iso = "pt-BR", text = "Pressione " .. KBM_PURGE_BUTTON .. " no teclado ou " .. GPAD_PURGE_BUTTON .. " no controle para limpar seu NOS no estilo Fast & Furious." },
    { iso = "ru-RU", text = "Нажмите " .. KBM_PURGE_BUTTON .. " на клавиатуре или " .. GPAD_PURGE_BUTTON .. " на контроллере, чтобы очистить NOS в стиле Fast & Furious." },
  },
  ...
  ["rod_tt"] = {
    { iso = "en-US", text = "Press " .. KBM_ROD_BUTTON .. " On Keyboard or " .. GPAD_ROD_BUTTON .. " On Controller To Instantly Ragdoll. The Longer You Hold The Button, The Longer You Stay On The Ground.\10(Doesn't work with 'Clumsy')" },
    { iso = "de-DE", text = "Drücken Sie " .. KBM_ROD_BUTTON .. " auf der Tastatur oder " .. GPAD_ROD_BUTTON .. " auf dem Controller, um sofort Ragdoll zu spielen. Je länger du die Taste gedrückt hältst, desto länger bleibst du auf dem Boden.\10(Funktioniert nicht mit 'Clumsy')" },
    { iso = "fr-FR", text = "Appuyez sur " .. KBM_ROD_BUTTON .. " sur le clavier ou sur " .. GPAD_ROD_BUTTON .. " sur la manette pour ragdoller instantanément. Plus vous maintenez le bouton enfoncé, plus vous restez au sol.\10(Ne fonctionne pas avec 'Clumsy')" },
    { iso = "it-IT", text = "Premi " .. KBM_ROD_BUTTON .. " sulla tastiera o " .. GPAD_ROD_BUTTON .. " sul controller per fare immediatamente Ragdoll. Più a lungo tieni premuto il pulsante, più a lungo rimani a terra.\10(Non funziona con 'Maldestro')" },
    { iso = "pt-BR", text = "Pressione " .. KBM_ROD_BUTTON .. " no teclado ou " .. GPAD_ROD_BUTTON .. " no controle para fazer Ragdoll instantaneamente. Quanto mais tempo você segurar o botão, mais tempo ficará no chão.\10(Não funciona com 'Clumsy')" },
    { iso = "ru-RU", text = "Нажмите " .. KBM_ROD_BUTTON .. " на клавиатуре или " .. GPAD_ROD_BUTTON .. " на контроллере, чтобы мгновенно превратиться в Ragdoll. Чем дольше вы держите кнопку, тем дольше вы остаетесь на земле.\10 (Не работает с «Неуклюжим»)" },
  },
  ...
  ["autofillDelay_tt"] = {
    { iso = "en-US", text = "A global delay for all 'autofill' options in Business Manager. The delay is in milliseconds." },
    { iso = "de-DE", text = "Eine globale Verzögerung für alle AutoFill-Optionen im Business Manager. Die Verzögerung wird in Millisekunden angegeben." },
    { iso = "fr-FR", text = "Un délai global pour toutes les options de remplissage automatique dans Business Manager. Le délai est exprimé en millisecondes." },
    { iso = "it-IT", text = "Un ritardo globale per tutte le opzioni di riempimento automatico in Business Manager. Il ritardo è in millisecondi." },
  ...
  ["sort_by_txt"] = {
    { iso = "en-US", text = "Sort By: " },
    { iso = "de-DE", text = "Sortieren nach: " },
    { iso = "fr-FR", text = "Trier Par : " },
    { iso = "it-IT", text = "Ordina Per: " },
    { iso = "pt-BR", text = "Ordenar Por: " },
    { iso = "ru-RU", text = "Сортировать по: " },
  },

  ["color_txt"] = {
    { iso = "en-US", text = "Color" },
    { iso = "de-DE", text = "Farbe" },
    { iso = "fr-FR", text = "Couleur" },
    { iso = "it-IT", text = "Colore" },
    { iso = "pt-BR", text = "Cor" },
    { iso = "ru-RU", text = "Цвет" },
  },

  ["manufacturer_txt"] = {
    { iso = "en-US", text = "Manufacturer" },
    { iso = "de-DE", text = "Hersteller" },
    { iso = "fr-FR", text = "Fabricant" },
    { iso = "it-IT", text = "Produttore" },
    { iso = "pt-BR", text = "Fabricante" },
    { iso = "ru-RU", text = "Производитель" },
  },
