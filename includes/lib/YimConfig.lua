...
local function YimConfig()
  ...
  local writeToFile = function(data)
    ...
    file:write(json:encode(data, etc, { pretty = true, indent = "  " }))
    file:close()
    return true
  end
  ...
  ---@param data any
  ---@param etc? any
  ---@param pretty_encode boolean
  function yc:encode(data, etc, pretty_encode)
    return json:encode(data, etc, { pretty = pretty_encode })
  end

  ---@param data any
  ---@param etc? any
  ---@param strict boolean
  function yc:decode(data, etc, strict)
    return json:decode(data, etc, { strictParsing = strict })
  end
