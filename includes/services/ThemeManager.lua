...
local ThemeLibrary <const> = {
    Tenebris = {
        ...
        TopBarFrameCol1 = vec4:new(0.36, 0.50, 0.90, 1.00), -- same as CheckMark
        TopBarFrameCol2 = vec4:new(0.33, 0.40, 0.85, 0.80) -- same as SliderGrab
    },
    ...
    MidnightNeon = {
        ...
        TopBarFrameCol1 = vec4:new(0.00, 0.85, 0.80, 1.00), -- same as CheckMark
        TopBarFrameCol2 = vec4:new(0.60, 0.10, 0.90, 0.80) -- same as SliderGrab
    },
    ...
    SilverLight = {
        ...
        TopBarFrameCol1 = vec4:new(0.15, 0.35, 0.80, 1.00), -- same as CheckMark
        TopBarFrameCol2 = vec4:new(0.10, 0.30, 0.80, 0.90) -- same as SliderGrab
    }
}
